...
const pieces: Piece[] = [
  ...
  // Hidden on mobile because this band position sits over the Legacy CTA.
  { left: '18%', top: '30%', size: 32, rotate: 22, color: '#F4592B', kind: 'paper', speed: 0.6, hideOnMobile: true },

  // Around the diagonal seam (roughly 40% of the band)
  { left: '2%', top: '52%', size: 74, rotate: -14, color: '#F4592B', kind: 'paper', speed: 0.2, blur: 4 },
  { left: '42%', top: '46%', size: 56, rotate: 16, color: '#FBBF24', kind: 'crescent', speed: 0.7, hideOnMobile: true },
  ...
  { left: '26%', top: '56%', size: 34, rotate: 22, color: '#F4592B', kind: 'paper', speed: 0.85, hideOnMobile: true },
  ...
  { left: '28%', top: '72%', size: 30, rotate: 34, color: '#EF4444', kind: 'triangle', speed: 0.95, hideOnMobile: true },
  { left: '68%', top: '76%', size: 34, rotate: 18, color: '#FCD9A0', kind: 'paper', speed: 0.5, hideOnMobile: true },
  { left: '11%', top: '78%', size: 52, rotate: -26, color: '#F59E0B', kind: 'crescent', speed: 0.4, hideOnMobile: true },

  // Mobile-only scatter: safely below the CTA and balanced on the left and right.
  { left: '5%', top: '67%', size: 27, rotate: 28, color: '#EF4444', kind: 'triangle', speed: 0.18, showOnMobileOnly: true },
  { left: '17%', top: '64%', size: 30, rotate: -32, color: '#F59E0B', kind: 'crescent', speed: 0.22, showOnMobileOnly: true },
  { left: '24%', top: '78%', size: 32, rotate: 18, color: '#F4592B', kind: 'paper', speed: 0.16, showOnMobileOnly: true },
  { left: '69%', top: '74%', size: 32, rotate: 22, color: '#FBBF24', kind: 'crescent', speed: 0.2, showOnMobileOnly: true },
  { left: '79%', top: '52%', size: 48, rotate: 18, color: '#F4592B', kind: 'paper', speed: 0.24, showOnMobileOnly: true },
  { left: '84%', top: '65%', size: 28, rotate: -24, color: '#EF4444', kind: 'triangle', speed: 0.18, showOnMobileOnly: true },
  { left: '91%', top: '79%', size: 26, rotate: -16, color: '#FCD9A0', kind: 'paper', speed: 0.16, showOnMobileOnly: true },
];
